...
public class Gui {
	...
	Button b1, b2, b3, b4, bExtrude, bGrow, bShrink, bSubdivide, bDeselect,
			bSPLen, bLock, bUnlock, bShell, bLattice, bc1, bc2, bc3, bc4, bc5,
			bc6, bc7, bSaveFile, bReset;
	...
	Slider2D slider2d;
	Slider2D sliderZ;
	Slider scaleScaleIcons;

	Knob spl, gravityKnob, extrudeDistKnob, extrudeChanferKnob, shellDepthKnob,
			latticeDepthKnob, latticeOffsetKnob;
	RadioButton radB;
	int sizeIcons = 70; //100  //70 Medium
	int margin = 30; //50
	int space = 15; //20
	...
	void createButtonsSimple() {
		...
		gravityOn = cp5
				...
				.setPosition(margin, p5.height - margin - sizeIcons)
				.setImages(
						gravityOnImg,
						gravityOnImg,
						gravityOnImgAct)
		...
		gravityKnob = cp5
				...
				.setValue(9.80f)
				.setRange(-100f, 100f)
				.setPosition(margin + 3,
						p5.height - margin - sizeIcons * 2 + 3 - space)
				.setRadius(sizeIcons / 2 - 3).setResolution(100f)
				.setColorBackground(-16777216).setColorForeground(-1)
				.setColorActive(-65281);
		// ////////////////////////////////////
		bSaveFile = cp5
				.addButton("EXPORT_OBJ")
		...
		bMoveLeft = cp5
				.addButton("MOVE_LEFT")
				.setPosition(
						margin + sizeIcons * 2 + space * 2 - 45 - 2 + sizeIcons
								/ 2,
		...
		extrudeDistKnob = cp5
				...
				.setRange(-100, 100)
				.setValue(30)
				.setPosition(margin + sizeIcons * 2 + space * 2 + 3,
						margin + 3 + sizeIcons * 4 + space * 4)
				.setRadius(sizeIcons / 2 - 3).setResolution(100f)
				.setColorBackground(-16777216).setColorForeground(-1)
				.setColorActive(-65281).setLabel("dist");
		bc3 = cp5
				.addButton("circle3")
		...
		extrudeChanferKnob = cp5
				...
				.setValue(.2f)
				.setRange(0f, 1)
				.setPosition(margin + sizeIcons * 2 + space * 3 + 75 + 3,
						margin + 3 + sizeIcons * 4 + space * 4)
				.setRadius(sizeIcons / 2 - 3).setResolution(100f)
				.setColorBackground(-16777216).setColorForeground(-1)
				.setColorActive(-65281).setLabel("chanfer");
		...
		latticeOffsetKnob = cp5
				...
				.setRadius(sizeIcons / 2 - 3).setResolution(100f)
				.setColorBackground(-16777216).setColorForeground(-1)
				.setColorActive(-65281).setLabel("offset");
		// ////////////////////////////////////
		bSPLen = cp5
				.addButton("ACTIVATE_SPLEN")
				.setPosition(margin + sizeIcons + space,
		...
		spl = cp5
				...
				.setValue(100f)
				.setRange(50f, 200f)
				.setPosition(margin + sizeIcons * 1 + space * 3 + 75 + 3,
						margin + 3 + sizeIcons * 7 + space * 7)
				.setRadius(sizeIcons / 2 - 3).setResolution(100f)
				.setColorBackground(-16777216).setColorForeground(-1)
				.setColorActive(-65281).setLabel("SP_length");

		// ////////////////////////////////////
		int widthSliderIncons = 200;
		scaleScaleIcons = cp5.addSlider("SCALEICONS").setPosition(p5.width-2*margin-widthSliderIncons-this.sizeIcons, margin)
				.setWidth(widthSliderIncons).setRange(1, 10).setColorForeground(p5.color(255,0,255))
				// values can range from big to small as well
				.setValue(128).setNumberOfTickMarks(30)
				.setSliderMode(Slider.FLEXIBLE).setColorBackground(255).setLabel("");
		// ////////////////////////////////////
	...
	void updateSelector() {
		if (p5.selectionMode == 2)
			bFaces.setValue(true);
		if (p5.selectionMode == 1)
			bEdges.setValue(true);
		if (p5.selectionMode == 0)
			bVertex.setValue(true);
	}
	...
	void updateButtonsSimple() {
		...
		if ((!bVertex.isActive() && (!bVertex.getState()))
				&& ((!bVertex.isMouseOver()))) {
			if (p5.activeSPLen) {
				bSPLen.setImage(p5
		...
		if (bFaces.isActive() || (bFaces.getState() || (bFaces.isMouseOver()))) {
			bMove.setPosition(margin + sizeIcons + space, margin + sizeIcons
					+ space);
			bLock.setPosition(margin + sizeIcons + space, margin + sizeIcons
					* 3 + space * 3);
			bUnlock.setPosition(margin + sizeIcons * 2 + space * 2, margin
					+ sizeIcons * 3 + space * 3);

			bMoveUp.setPosition(margin + sizeIcons * 2 + space * 2 + sizeIcons
					/ 2, margin + sizeIcons + space);
			bMoveDown.setPosition(margin + sizeIcons * 2 + space * 2
					+ sizeIcons / 2, margin + sizeIcons + space + sizeIcons / 2
					+ 4);
			bMoveLeft.setPosition(margin + sizeIcons * 2 + space * 2 - sizeIcons/2 - 2
					+ sizeIcons / 2, margin + sizeIcons + space + sizeIcons / 2
					- 45 / 2);
			bMoveRight.setPosition(margin + sizeIcons * 2 + space * 2 + sizeIcons/2 + 2
					+ sizeIcons / 2, margin + sizeIcons + space + sizeIcons / 2
					- 45 / 2);
			bMoveZUp.setPosition(margin + sizeIcons * 3 + space * 3 + sizeIcons
					/ 2, margin + sizeIcons + space);
			bMoveZDown.setPosition(margin + sizeIcons * 3 + space * 3
					+ sizeIcons / 2, margin + sizeIcons + space + sizeIcons / 2
					+ 4);
			...
			// bc7.show();
			// spl.show();
			bSPLen.setPosition(margin + sizeIcons + space, margin + sizeIcons
					* 7 + space * 7);
			bc7.setPosition(margin + sizeIcons * 1 + space * 3 + 75, margin
					+ sizeIcons * 7 + space * 7);
			spl.setPosition(margin + sizeIcons * 1 + space * 3 + 75 + 3, margin
					+ 3 + sizeIcons * 7 + space * 7);
			...
			if ((!bEdges.isActive() && (!bFaces.getState()))
					&& (!bVertex.isActive() && (!bVertex.getState()))
					&& (!bVertex.isMouseOver() && (!bVertex.isMouseOver()))) {
				// bMove.hide();
				// bLock.hide();
				// bUnlock.hide();
				// test
		...
		//
		// if (!bFaces.isActive() && (!bEdges.isActive() &&
		// (!bVertex.isActive()))) {
		// bMove.hide();
		// bLock.hide();
		// bUnlock.hide();
		...
		// if (bEdges.isActive() || (bEdges.getState() ||
		// (bEdges.isMouseOver()))) {
		// bMove.show();
		// bLock.show();
		// bUnlock.show();
		...
		// }
		if ((!bEdges.isActive())
				&& (!bVertex.isActive() && (!bFaces.isActive()))) {

		}

		if ((bEdges.isActive() || (bEdges.getState()))
				|| (bVertex.isActive() || (bVertex.getState()))
				|| ((bEdges.isMouseOver() || (bVertex.isMouseOver())))) {
			if ((!bFaces.isMouseOver())) {
				...
				bLock.setPosition(margin + sizeIcons + space, margin
						+ sizeIcons * 1 + space * 1);
				bUnlock.setPosition(margin + sizeIcons * 2 + space * 2, margin
						+ sizeIcons * 1 + space * 1);

				bMoveUp.setPosition(margin + sizeIcons * 2 + space * 2
						+ sizeIcons / 2, margin + 0 + 0);
				bMoveDown.setPosition(margin + sizeIcons * 2 + space * 2
						+ sizeIcons / 2, margin + 0 + 0 + sizeIcons / 2 + 4);
				
				bMoveLeft.setPosition(margin + sizeIcons * 2 + space * 2 - sizeIcons/2 - 2
						+ sizeIcons / 2, margin + 0 + 0 + sizeIcons / 2
						- 45 / 2);
				bMoveRight.setPosition(margin + sizeIcons * 2 + space * 2 + sizeIcons/2 + 2
						+ sizeIcons / 2, margin + 0 + 0 + sizeIcons / 2
						- 45 / 2);
				bMoveZUp.setPosition(margin + sizeIcons * 3 + space * 3
						+ sizeIcons / 2, margin + 0 + 0);
				bMoveZDown.setPosition(margin + sizeIcons * 3 + space * 3
						+ sizeIcons / 2, margin + 0 + 0 + sizeIcons / 2 + 4);
		...
		if ((bEdges.isActive() || (bEdges.getState()))
			...
			if ((!bFaces.isMouseOver())) {
				...
				// bc7.show();
				// spl.show();
				bSPLen.setPosition(margin + sizeIcons + space, margin
						+ sizeIcons * 2 + space * 2);
				bc7.setPosition(margin + sizeIcons * 1 + space * 3 + 75, margin
						+ sizeIcons * 2 + space * 2);
				spl.setPosition(margin + sizeIcons * 1 + space * 3 + 75 + 3,
						margin + 3 + sizeIcons * 2 + space * 2);
				// ////////////////////////////////////
			}
		}
		if ((bVertex.isActive() || (bVertex.getState()))
	...
	void createButtons() {
		...
		float rad = 30;
		spl = cp5.addKnob("SP_LENGTH").setValue(100f).setRange(0f, 200f)
				.setPosition(50, 50).setRadius(rad).setResolution(100f);
		cp5.addKnob("GRAVITY").setValue(9.80f).setRange(-100f, 100f)
				.setPosition(50 + 35 + rad, 50).setRadius(rad)
				.setResolution(100f);

		slider2d = cp5
				.addSlider2D("PARTICLE-XY")
				.setPosition(50, 160)
				.setSize(size2dSlider, size2dSlider)
				.setArrayValue(
						new float[] { size2dSlider / 2, size2dSlider / 2 });// .disableCrosshair();
		sliderZ = cp5
				.addSlider2D("PARTICLE-Z")
				.setPosition(offsetSliders + size2dSlider, 160)
				.setSize(size2dSlider / 10, size2dSlider)
				.setArrayValue(
						new float[] { size2dSlider / 2, size2dSlider / 2 })
				.setLabelVisible(false).setLabel("");// .disableCrosshair();

		b1 = cp5.addButton("REMOVE_ELEMENT", 10, 50, 310 + size2dSlider,
				(int) buttonDefWidth * 2 / 3 - 2, 20).setId(7);
		t1 = cp5.addToggle("KILL_SPRINGS")
				.setPosition(50 + buttonDefWidth * 2 / 3, 310 + size2dSlider)
				.setSize(buttonDefWidth / 3, 20).setValue(true)
				.setMode(ControlP5.SWITCH).setLabelVisible(false);
		b2 = cp5.addButton("LOCK_ELEMENT", 10, 50, 340 + size2dSlider,
				120 / 2 - 3, 20).setId(8).setLabel("lock");
		b3 = cp5.addButton("UNLOCK_ELEMENT", 10, 114, 340 + size2dSlider,
				120 / 2 - 3, 20).setId(6).setLabel("unlock");

		// /---Group selection----////
		g1 = cp5.addGroup("SELECTION_OPTIONS").setPosition(50, 300)
				.setWidth(buttonDefWidth).activateEvent(true)
				.setBackgroundColor(p5.color(255, 80)).setBackgroundHeight(100)
				.setLabel("selection");
		MultiList l = cp5.addMultiList("myList", 10, 10, buttonDefWidth, 12)
				.setWidth(buttonDefWidth - 20).setGroup(g1);
		...
		cp5.addButton("SELECT_ALL").setPosition(10, 45)
				.setWidth(buttonDefWidth - 20).setId(9).setGroup(g1);
		cp5.addButton("DESELECT").setPosition(10, 70)
				.setWidth(buttonDefWidth - 20).setId(9).setGroup(g1);

		// /---Group subdivision----////
		g2 = cp5.addGroup("SUBDIVIDE_OPTIONS").setPosition(50, 480)
				.setWidth(buttonDefWidth).activateEvent(true)
				.setBackgroundColor(p5.color(255, 80)).setBackgroundHeight(160)
				.setLabel("subdivide");
		radB = cp5.addRadioButton("SUBDIVIDE_RADIO").setPosition(10, 10)
				.setSize(20, 9).addItem("CatmullClark", 0)
				.addItem("DooSabin", 1).addItem("Planar", 2)
				.addItem("PlanarMidEdge", 3).addItem("Smooth", 4)
				.addItem("Tridec", 5).setGroup(g2);
		cp5.addSlider("SUBDIVIDE_LEVEL").setPosition(10, 110).setSize(73, 9)
				.setGroup(g2).show().setRange(1, 4).setDecimalPrecision(0)
				.setNumberOfTickMarks(4).setLabel("level")
				.setSliderMode(Slider.FLEXIBLE);
		cp5.addToggle("SUBDIVIDE_KEEPEDGES").setPosition(10, 80).setSize(47, 9)
				.setValue(true).setMode(ControlP5.SWITCH).setLabel("keepEdges")
				.setGroup(g2);
		cp5.addToggle("SUBDIVIDE_KEEPBOUND").setPosition(62, 80).setSize(47, 9)
				.setValue(true).setMode(ControlP5.SWITCH).setLabel("keepBound")
				.setGroup(g2);
		cp5.addButton("SUBDIVIDE_RUN").setPosition(10, 132)
				.setWidth(buttonDefWidth - 20).setId(9).setLabel("subdivide")
				.setGroup(g2);

		// /---Group extrusion----////
		g3 = cp5.addGroup("ENTRUDE_OPTIONS").setPosition(50, 660)
				.setWidth(buttonDefWidth).activateEvent(true)
				.setBackgroundColor(p5.color(255, 80)).setBackgroundHeight(100)
				.setLabel("extrude");
		cp5.addSlider("EXTRUSION_CHANFER").setPosition(10, 10).setSize(60, 9)
				.setRange(0, 1).setLabel("chanfer").setGroup(g3);
		cp5.addSlider("EXTRUSION_DISTANCE").setPosition(10, 20).setSize(60, 9)
				.setRange(-100, 100).setValue(0).setNumberOfTickMarks(3)
				.snapToTickMarks(false).setSliderMode(Slider.FLEXIBLE)
				.setLabel("distance").setGroup(g3);
		cp5.addToggle("EXTRUDE_SELECTNEIGHBOUR").setPosition(10, 45)
				.setSize(47, 9).setValue(false).setMode(ControlP5.SWITCH)
				.setGroup(g3).setLabel("selNeigh.");
		cp5.addToggle("EXTRUDE_LOCKPARTICLES").setPosition(62, 45)
				.setSize(47, 9).setValue(false).setMode(ControlP5.SWITCH)
				.setGroup(g3).setLabel("lockPart.");
		cp5.addButton("EXTRUDE_RUN").setPosition(10, 70)
				.setWidth(buttonDefWidth - 20).setId(9).setLabel("extrude")
				.setGroup(g3);

		// /---Group lattice----////
		g4 = cp5.addGroup("LATTICE_GROUP").setPosition(50, 780)
				.setWidth(buttonDefWidth).activateEvent(true)
				.setBackgroundColor(p5.color(255, 80)).setBackgroundHeight(110)
				.setLabel("lattice");
		cp5.addSlider("LATTICE_DEPTH").setPosition(10, 20).setSize(60, 9)
				.setRange(-100, 100).setValue(0).setNumberOfTickMarks(3)
				.snapToTickMarks(false).setSliderMode(Slider.FLEXIBLE)
				.setLabel("distance").setGroup(g4);
		cp5.addSlider("LATTICE_WIDTH").setPosition(10, 10).setSize(60, 9)
				.setRange(0, 150).setLabel("width").setGroup(g4);
		cp5.addToggle("LATTICE_SELOLD").setPosition(10, 45).setSize(30, 9)
				.setValue(false).setMode(ControlP5.SWITCH).setGroup(g4)
				.setLabel("s_old");
		cp5.addToggle("LATTICE_SELNEW").setPosition(45, 45).setSize(30, 9)
				.setValue(false).setMode(ControlP5.SWITCH).setGroup(g4)
				.setLabel("s_new");
		cp5.addToggle("LATTICE_LOCKPARTICLES").setPosition(80, 45)
				.setSize(30, 9).setValue(false).setMode(ControlP5.SWITCH)
				.setGroup(g4).setLabel("lock");
		cp5.addButton("LATTICE_RUN").setPosition(10, 70)
				.setWidth(buttonDefWidth - 20).setId(9).setLabel("lattice")
				.setGroup(g4);

		// /---Group export----////180
		g5 = cp5.addGroup("EXPORT_OPTIONS")
				.setPosition(50, this.p5.height - 150).setWidth(buttonDefWidth)
				.activateEvent(true).setBackgroundColor(p5.color(255, 80))
				.setBackgroundHeight(40);
		cp5.addButton("EXPORT_STL").setPosition(10, 10).setSize(47, 20)
				.setLabel("STL").setGroup(g5);
		cp5.addButton("EXPORT_OBJ").setPosition(62, 10).setSize(47, 20)
				.setLabel("OBJ").setGroup(g5);

		cp5.addToggle("UPDATE_PHYSICS").setPosition(50, p5.height - 100)
				.setSize(buttonDefWidth, 20).setValue(false)
				.setMode(ControlP5.SWITCH);
		cp5.addButton("RESET", 10, 50, p5.height - 50, buttonDefWidth, 20)
				.setId(3);

		cp5.addToggle("DISPLAY_SELECTORS")
				.setPosition(p5.width - 120, p5.height - 150 - 20)
				.setSize(80, 20).setValue(true).setMode(ControlP5.SWITCH);
		cp5.addToggle("DISPLAY_MESH")
				.setPosition(p5.width - 120, p5.height - 50 - 20)
				.setSize(80, 20).setValue(true).setMode(ControlP5.SWITCH);
	...
	void updateButtons() {
		if (g1.isOpen()) {
			...
			if (g2.isOpen())
				g3.setPosition(50, 660);
			else
				g3.setPosition(50, 660 - g2.getBackgroundHeight());
			if ((g2.isOpen()) && (g3.isOpen()))
				g4.setPosition(50, 780);
			if ((g2.isOpen()) && (!g3.isOpen()))
				g4.setPosition(50, 780 - g3.getBackgroundHeight());
			if ((!g2.isOpen()) && (g3.isOpen()))
				g4.setPosition(50, 780 - g2.getBackgroundHeight());
			if ((!g2.isOpen()) && (!g3.isOpen()))
				g4.setPosition(
						50,
						780 - g2.getBackgroundHeight()
								- g3.getBackgroundHeight());
		} else {
			b1.setPosition(50, 310 + size2dSlider - g1.getBackgroundHeight());
			t1.setPosition(50 + buttonDefWidth * 2 / 3,
					310 + size2dSlider - g1.getBackgroundHeight());
			...
			if (g2.isOpen())
				g3.setPosition(50, 660 - g1.getBackgroundHeight());
			else
				g3.setPosition(
						50,
						660 - g1.getBackgroundHeight()
								- g2.getBackgroundHeight());
			if ((g2.isOpen()) && (g3.isOpen()))
				g4.setPosition(50, 780 - g1.getBackgroundHeight());
			if ((g2.isOpen()) && (!g3.isOpen()))
				g4.setPosition(
						50,
						780 - g3.getBackgroundHeight()
								- g1.getBackgroundHeight());
			if ((!g2.isOpen()) && (g3.isOpen()))
				g4.setPosition(
						50,
						780 - g2.getBackgroundHeight()
